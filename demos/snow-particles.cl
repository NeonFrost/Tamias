...
(add-key :scancode-down snow-particles :down (set-nika 1))
(add-key :scancode-up snow-particles :down (set-nika 2))
(add-key :scancode-right snow-particles :down (set-nika 3))
(add-key :scancode-left snow-particles :down (set-nika 4))
(add-key :scancode-down snow-particles :up (reset-nika 1)
	 (setf (vector-3d-y (nika-vector nika)) 0))
(add-key :scancode-up snow-particles :up (reset-nika 2)
	 (setf (vector-3d-y (nika-vector nika)) 0))
(add-key :scancode-right snow-particles :up (reset-nika 3)
	 (setf (vector-3d-x (nika-vector nika)) 0))
(add-key :scancode-left snow-particles :up (reset-nika 4)
	 (setf (vector-3d-x (nika-vector nika)) 0))
